                    ...
                    <div class="item">
                        ...
                        <div class="temp">
                            <div class="temp-left detail">
                                ...
                                <div class="box">
                                    <p class="name">卖场简介：</p>
                                    <input type="text" class="text" name="header[McDescribe]">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="temp" style="background:none;">
                            <div class="temp-left detail2" style="background:#fff;">
                                ...
                                <div class="box">
                                    <p class="name">系列标题：</p>
                                    <input type="text" class="text" name="series[title]">
                                </div>
                                <div class="box">
                                    <p class="name">系列名称：</p>
                            ...
                            <div class="temp-right detail2" style="background:#fff";>
                                ...
                                <div class="box">
                                    <p class="name">系列描述：</p>
                                    <input type="text" class="text" name="series[describe]"">
                                </div>
                                <div class="box">
                                    <p class="name">背景图片：</p>
                                    <input type="file" class="text" name="seriesBackground">
                                </div>
                            </div>
                        </div>
                        <div class="mt-10"></div>
                        <div class="temp">
                            <div class="temp-left detail">
                                ...
                                <div class="box">
                                    <p class="name">品牌名称：</p>
                                    <input type="text" class="text" name="product[0][brand]">
                                </div>
                                <div class="box">
                                    <p class="name">产品名称：</p>
                                    <input type="text" class="text" name="product[0][name]">
                                </div>
                                <div class="box">
                                    <p class="name">产品型号：</p>
                                ...
                                <div class="box">
                                    <p class="name">产品补贴：</p>
                                    <input type="text" class="text" name="product[0][subsidy]">
                                </div>
                                <div class="box">
                                    <p class="name">产品图片：</p>
                            ...
                            <div class="temp-left detail" style="border-left:1px solid #ededed;margin-left:28px;">
                                ...
                                <div class="box">
                                    <p class="name">品牌名称：</p>
                                    <input type="text" class="text" name="product[1][brand]">
                                </div>
                                <div class="box">
                                    <p class="name">产品名称：</p>
                                    <input type="text" class="text" name="product[1][name]">
                                </div>
                                <div class="box">
                                    <p class="name">产品型号：</p>
                                ...
                                <div class="box">
                                    <p class="name">产品补贴：</p>
                                    <input type="text" class="text" name="product[1][subsidy]">
                                </div>
                                <div class="box">
                                    <p class="name">产品图片：</p>
