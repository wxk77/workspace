                        ...
                        <div class="item">
                            ...
                            <div class="temp" style="background:none;">
                                ...
                                <div class="temp-right detail2" style="background:#fff";>
                                    ...
                                    <div class="box">
                                        ...
                                        <input type="hidden" name="series[background]" value="<?=$special['series']['background']?>">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-10"></div>
                            <div class="temp">
                                <div class="temp-left detail">
                                    ...
                                    <div class="box">
                                        <p class="name">品牌名称：</p>
                                        <input type="text" class="text" name="product[0][brand]" value="<?=$special['product'][0]['brand']?>">
                                    </div>
                                    <div class="box">
                                        <p class="name">产品名称：</p>
                                ...
                                <div class="temp-left detail" style="border-left:1px solid #ededed;margin-left:28px;">
                                    ...
                                    <div class="box">
                                        <p class="name">品牌名称：</p>
                                        <input type="text" class="text" name="product[1][brand]" value="<?=$special['product'][1]['brand']?>">
                                    </div>
                                    <div class="box">
                                        <p class="name">产品名称：</p>
