                    ...
                    <div class="item">
                        ...
                        <div class="temp" style="background:none;">
                            <div class="temp-left detail2" style="background:#fff;">
                                ...
                                <div class="box">
                                    <p class="name">系列名称：</p>
                                    <input type="text" class="text" name="series[name]" value="<?=$special['series']['name']?>">
                                </div>
                                <div class="box">
                                    <p class="name">系列图片：</p>
                            ...
                            <div class="temp-right detail2" style="background:#fff";>
                                ...
                                <div class="box">
                                    <p class="name">品牌名称：</p>
                                    <input type="text" class="text" name="brand[name]" value="<?=$special['brand']['name']?>">
                                </div>
                                <div class="box">
                                    <p class="name">品牌简介：</p>
                                    <input type="text" class="text" name="brand[describe]" value="<?=$special['brand']['describe']?>">
                                </div>
                            </div>
                        </div>
                        <div class="mt-10"></div>
                        <div class="temp">
                            <div class="temp-left detail">
                                ...
                                <div class="box">
                                    <p class="name">产品编号：</p>
                                    <input type="text" class="text" name="product[0][number]" value="<?=$special['product'][0]['number']?>">
                                </div>
                                <div class="box">
                                    <p class="name">产品型号：</p>
                                ...
                                <div class="box">
                                    <p class="name">产品概要：</p>
                                    <input type="text" class="text" name="product[0][describe]" value="<?=$special['product'][0]['describe']?>">
                                </div>
                                <div class="box">
                                    <p class="name">产品图片：</p>
                            ...
                            <div class="temp-left detail" style="border-left:1px solid #ededed;margin-left:28px;">
                                ...
                                <div class="box">
                                    <p class="name">产品编号：</p>
                                    <input type="text" class="text" name="product[1][number]" value="<?=$special['product'][1]['number']?>">
                                </div>
                                <div class="box">
                                    <p class="name">产品型号：</p>
                                ...
                                <div class="box">
                                    <p class="name">产品概要：</p>
                                    <input type="text" class="text" name="product[1][describe]" value="<?=$special['product'][0]['describe']?>">
                                </div>
                                <div class="box">
                                    <p class="name">产品图片：</p>
