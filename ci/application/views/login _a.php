...
<link href="H-ui/static/h-ui/css/H-ui.login.css" rel="stylesheet" type="text/css" />
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="index.php/Login/doLogin" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
         ...
         <a id="kanbuq" onclick="changeimg()" href="javascript:;">看不清，换一张</a></div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <a href="javascript:;" onclick="admin_add('注册','Form/adminaddpage','800','500')" class="btn btn-default radius size-L">&nbsp;注&nbsp;&nbsp;&nbsp;&nbsp;册&nbsp;</a> 
        </div>
      </div>
    </form>
  </div>
