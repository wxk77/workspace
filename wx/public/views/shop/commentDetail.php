...
<head>
    ...
    <title>卖场网-<?=$data['title']?></title>
    <link rel="stylesheet" href="/public/css/mui.min.css">
    <link rel="stylesheet" href="/public/css/reset_pj.css" />
    <link rel="stylesheet" type="text/css" href="/public/css/picSelDetails2.css"/>
        ...
        <div class="mui-slider pj_slider">
            <div class="mui-slider-group pj_group">
                ...
                <div class="mui-slider-item">
                    <a class="img_box" href="#"><img class="img" src="<?=$image?>" data-preview-src=""
                                                     data-preview-group="1"/></a>
                    <div class="details">
                        <div class="de_h"><p><?=$data['content'];?></p></div>
                        <div class="de_f">
                            <div class="star">
                                <?=$data['stars']?>
                            </div>
